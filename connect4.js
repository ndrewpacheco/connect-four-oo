...
class Game {
  ...
  configurePlayers() {
    const colorP1 = document.getElementById("p1-color").value;
    const colorP2 = document.getElementById("p2-color").value;

    this.p1 = new Player(colorP1);
    this.p2 = new Player(colorP2);
  }
  ...
  handleClick(evt) {
    // if game is finished, disable click event
